...
[javascript mode](https://codemirror.net/mode/javascript/schoolAdminHome.php): Add support for TypeScript template string types, improve integration with JSX mode.
...
[clojure mode](https://codemirror.net/mode/clojure/schoolAdminHome.php): Fix regexp that matched in exponential time for some inputs.
...
[pascal mode](https://codemirror.net/mode/pascal/schoolAdminHome.php): Recognize curly bracket comments.
...
[octave mode](https://codemirror.net/mode/octave/schoolAdminHome.php): Don't mark common punctuation as error.
...
[sparql mode](https://codemirror.net/mode/sparql/schoolAdminHome.php): Allow non-ASCII identifier characters.
...
[scheme mode](https://codemirror.net/mode/scheme/schoolAdminHome.php): Improve highlighting of quoted expressions.
...
Add `hintWords` (basic completion) helper to [clojure](https://codemirror.net/mode/clojure/schoolAdminHome.php), [mllike](https://codemirror.net/mode/mllike/schoolAdminHome.php), [julia](https://codemirror.net/mode/julia/), [shell](https://codemirror.net/mode/shell/), and [r](https://codemirror.net/mode/r/) modes.

[clojure mode](https://codemirror.net/mode/clojure/schoolAdminHome.php): Clean up and improve.
...
[mllike mode](https://codemirror.net/mode/mllike/schoolAdminHome.php): Improve OCaml support.
...
[jsx mode](https://codemirror.net/mode/jsx/schoolAdminHome.php): Support JSX fragments.
...
Add the [mbox mode](https://codemirror.net/mode/mbox/schoolAdminHome.php) to `mode/meta.js`.
...
[Python mode](https://codemirror.net/mode/python/schoolAdminHome.php): Improve distinguishing of decorators from `@` operators.
...
[PowerShell mode](https://codemirror.net/mode/powershell/schoolAdminHome.php): Added.

[Yacas mode](https://codemirror.net/mode/yacas/schoolAdminHome.php): Added.

[Web IDL mode](https://codemirror.net/mode/webidl/schoolAdminHome.php): Added.

[SAS mode](https://codemirror.net/mode/sas/schoolAdminHome.php): Added.

[mbox mode](https://codemirror.net/mode/mbox/schoolAdminHome.php): Added.
...
[protobuf mode](https://codemirror.net/mode/protobuf/schoolAdminHome.php): Newly added.
...
[clike mode](https://codemirror.net/mode/clike/schoolAdminHome.php): No longer gets confused when a comment starts after an operator.

[markdown mode](https://codemirror.net/mode/markdown/schoolAdminHome.php): Now supports CommonMark-style flexible list indentation.

[dylan mode](https://codemirror.net/mode/dylan/schoolAdminHome.php): Several improvements and fixes.
...
* New modes: [JSX](https://codemirror.net/mode/jsx/schoolAdminHome.php), [literate Haskell](https://codemirror.net/mode/haskell-literate/schoolAdminHome.php)
...
* The [Swift](https://codemirror.net/mode/swift/schoolAdminHome.php) mode now supports auto-indentation
* Frontmatters in the [YAML frontmatter](https://codemirror.net/mode/yaml-frontmatter/schoolAdminHome.php) mode are now optional as intended
...
* The [Swift mode](https://codemirror.net/mode/swift/schoolAdminHome.php) was rewritten.
...
* New mode: [Crystal](https://codemirror.net/mode/crystal/schoolAdminHome.php).
...
* New modes: [NSIS](https://codemirror.net/mode/nsis/schoolAdminHome.php), [Ceylon](https://codemirror.net/mode/clike/schoolAdminHome.php)
* The Kotlin mode is now a [clike](https://codemirror.net/mode/clike/schoolAdminHome.php) dialect, rather than a stand-alone mode
...
* New modes: [Vue](https://codemirror.net/mode/vue/schoolAdminHome.php), [Oz](https://codemirror.net/mode/oz/schoolAdminHome.php), [MscGen](https://codemirror.net/mode/mscgen/schoolAdminHome.php) (and dialects), [Closure Stylesheets](https://codemirror.net/mode/css/gss.html)
* Implement [CommonMark](http://commonmark.org)-style flexible list indent and cross-line code spans in [Markdown](https://codemirror.net/mode/markdown/schoolAdminHome.php) mode
...
* Handle `async`/`await` and ocal and binary numbers in [JavaScript mode](https://codemirror.net/mode/javascript/schoolAdminHome.php)
* Fix various issues with the [Haxe mode](https://codemirror.net/mode/haxe/schoolAdminHome.php)
...
* Tokenize properties as properties in the [CoffeeScript mode](https://codemirror.net/mode/coffeescript/schoolAdminHome.php)
...
* The [Rust mode](https://codemirror.net/mode/rust/schoolAdminHome.php) was rewritten to handle modern Rust
...
*   New modes: [Brainfuck](https://codemirror.net/mode/brainfuck/schoolAdminHome.php), [VHDL](https://codemirror.net/mode/vhdl/schoolAdminHome.php), Squirrel ([clike](https://codemirror.net/mode/clike/schoolAdminHome.php) dialect)
...
*   New modes: [Twig](https://codemirror.net/mode/twig/schoolAdminHome.php), [Elm](https://codemirror.net/mode/elm/schoolAdminHome.php), [Factor](https://codemirror.net/mode/factor/schoolAdminHome.php), [Swift](https://codemirror.net/mode/swift/schoolAdminHome.php)
*   Prefer clipboard API (if available) when pasting
*   Refined definition highlighting in [clike](https://codemirror.net/mode/clike/schoolAdminHome.php) mode
...
*   New modes: [ASN.1](https://codemirror.net/mode/asn.1/schoolAdminHome.php), [TTCN](https://codemirror.net/mode/ttcn/schoolAdminHome.php), and [TTCN-CFG](https://codemirror.net/mode/ttcn-cfg/schoolAdminHome.php)
*   The [clike](https://codemirror.net/mode/clike/schoolAdminHome.php) mode can now deep-indent `switch` statements, and roughly recognizes types and defined identifiers
...
*   New modes: [MUMPS](https://codemirror.net/mode/mumps/schoolAdminHome.php), [Handlebars](https://codemirror.net/mode/handlebars/schoolAdminHome.php)
*   Rewritten modes: [Django](https://codemirror.net/mode/django/schoolAdminHome.php), [Z80](https://codemirror.net/mode/z80/schoolAdminHome.php)
...
*   New modes: [ASCII armor](https://codemirror.net/mode/asciiarmor/schoolAdminHome.php) (PGP data), [Troff](https://codemirror.net/mode/troff/schoolAdminHome.php), and [CMake](https://codemirror.net/mode/cmake/schoolAdminHome.php).
*   Remove SmartyMixed mode, rewrite [Smarty](https://codemirror.net/mode/smarty/schoolAdminHome.php) mode to supersede it.
...
*   New modes: [Forth](https://codemirror.net/mode/forth/schoolAdminHome.php), [Stylus](https://codemirror.net/mode/stylus/schoolAdminHome.php).
*   Make the [CSS mode](https://codemirror.net/mode/css/schoolAdminHome.php) understand some modern CSS extensions.
*   Have the [Scala mode](https://codemirror.net/mode/clike/schoolAdminHome.php) handle symbols and triple-quoted strings.
...
*   Improvements to the [Sass mode](https://codemirror.net/mode/sass/schoolAdminHome.php)'s indentation.
...
*   New modes: [Dart](https://codemirror.net/mode/dart/schoolAdminHome.php), [EBNF](https://codemirror.net/mode/ebnf/schoolAdminHome.php), [spreadsheet](https://codemirror.net/mode/spreadsheet/schoolAdminHome.php), and [Soy](https://codemirror.net/mode/soy/schoolAdminHome.php).
...
*   New modes: [dockerfile](https://codemirror.net/mode/dockerfile/schoolAdminHome.php), [IDL](https://codemirror.net/mode/idl/schoolAdminHome.php), [Objective C](https://codemirror.net/mode/clike/schoolAdminHome.php) (crude).
...
*   Improvements to modes: [gfm](https://codemirror.net/mode/gfm/schoolAdminHome.php) (strikethrough), [SPARQL](https://codemirror.net/mode/sparql/schoolAdminHome.php) (version 1.1 support), and [sTeX](https://codemirror.net/mode/stex/schoolAdminHome.php) (no more runaway math mode).
...
*   More mode improvements: [CoffeeScript](https://codemirror.net/mode/coffeescript/schoolAdminHome.php) (indentation), [Verilog](https://codemirror.net/mode/verilog/schoolAdminHome.php) (indentation), [Scala](https://codemirror.net/mode/clike/schoolAdminHome.php) (indentation, triple-quoted strings), and [PHP](https://codemirror.net/mode/php/schoolAdminHome.php) (interpolated variables in heredoc strings).
*   New modes: [Textile](https://codemirror.net/mode/textile/schoolAdminHome.php) and [Tornado templates](https://codemirror.net/mode/tornado/schoolAdminHome.php).
...
*   New mode: [Modelica](https://codemirror.net/mode/modelica/schoolAdminHome.php)
...
*   New mode: [Slim](https://codemirror.net/mode/slim/schoolAdminHome.php)
...
*   New mode: [Kotlin](https://codemirror.net/mode/kotlin/schoolAdminHome.php)
...
*   Rewritten [Jade](https://codemirror.net/mode/jade/schoolAdminHome.php) mode.
*   Various improvements to [Shell](https://codemirror.net/mode/shell/schoolAdminHome.php) (support for more syntax) and [Python](https://codemirror.net/mode/python/schoolAdminHome.php) (better indentation) modes.
*   New mode: [Cypher](https://codemirror.net/mode/cypher/schoolAdminHome.php).
...
*   New mode: [Django](https://codemirror.net/mode/django/schoolAdminHome.php).
*   Improved modes: [Verilog](https://codemirror.net/mode/verilog/schoolAdminHome.php) (rewritten), [Jinja2](https://codemirror.net/mode/jinja2/schoolAdminHome.php), [Haxe](https://codemirror.net/mode/haxe/schoolAdminHome.php), [PHP](https://codemirror.net/mode/php/schoolAdminHome.php) (string interpolation highlighted), [JavaScript](https://codemirror.net/mode/javascript/schoolAdminHome.php) (indentation of trailing else, template strings), [LiveScript](https://codemirror.net/mode/livescript/schoolAdminHome.php) (multi-line strings).
...
*   In the [XML mode](https://codemirror.net/mode/xml/schoolAdminHome.php), add `brackets` style to angle brackets, fix case-sensitivity of tags for HTML.
*   New mode: [Dylan](https://codemirror.net/mode/dylan/schoolAdminHome.php).
...
*   New mode: [Solr](https://codemirror.net/mode/solr/schoolAdminHome.php).
...
*   The [XML](https://codemirror.net/mode/xml/schoolAdminHome.php) and [CSS](https://codemirror.net/mode/css/schoolAdminHome.php) modes were largely rewritten. [LESS](https://codemirror.net/mode/css/less.html) support was added to the CSS mode.
*   The OCaml mode was moved to an [mllike](https://codemirror.net/mode/mllike/schoolAdminHome.php) mode, F# support added.
...
*   Better ECMAScript 6 support in [JavaScript](https://codemirror.net/mode/javascript/schoolAdminHome.php) mode.
*   Full [list of patches](https://github.com/codemirror/CodeMirror/compare/3.20.0...3.21.0).

## 3.20.0 (2013-11-21)

*   New modes: [Julia](https://codemirror.net/mode/julia/schoolAdminHome.php) and [PEG.js](https://codemirror.net/mode/pegjs/schoolAdminHome.php).
*   Support ECMAScript 6 in the [JavaScript mode](https://codemirror.net/mode/javascript/schoolAdminHome.php).
*   Improved indentation for the [CoffeeScript mode](https://codemirror.net/mode/coffeescript/schoolAdminHome.php).
...
*   New modes: [Eiffel](https://codemirror.net/mode/eiffel/schoolAdminHome.php), [Gherkin](https://codemirror.net/mode/gherkin/schoolAdminHome.php), [MSSQL dialect](https://codemirror.net/mode/sql/?mime=text/x-mssql).
...
*   New modes: [Fortran](https://codemirror.net/mode/fortran/schoolAdminHome.php), [Octave](https://codemirror.net/mode/octave/schoolAdminHome.php) (Matlab), [TOML](https://codemirror.net/mode/toml/schoolAdminHome.php), and [DTD](https://codemirror.net/mode/dtd/schoolAdminHome.php).
...
*   New modes: [Jade](https://codemirror.net/mode/jade/schoolAdminHome.php), [Nginx](https://codemirror.net/mode/nginx/schoolAdminHome.php).
...
*   Various improvements to [Ruby](https://codemirror.net/mode/ruby/schoolAdminHome.php), [Smarty](https://codemirror.net/mode/smarty/schoolAdminHome.php), [SQL](https://codemirror.net/mode/sql/schoolAdminHome.php), and [Vim](https://codemirror.net/demo/vim.html) modes.
*   Full [list of patches](https://github.com/codemirror/CodeMirror/compare/3.13.0...3.14.0).

## 3.13.0 (2013-05-20)

*   New modes: [COBOL](https://codemirror.net/mode/cobol/schoolAdminHome.php) and [HAML](https://codemirror.net/mode/haml/schoolAdminHome.php).
...
*   New mode: [GNU assembler](https://codemirror.net/mode/gas/schoolAdminHome.php).
...
*   **Removed code:** `collapserange`, `formatting`, and `simple-hint` addons. `plsql` and `mysql` modes (use [`sql`](https://codemirror.net/mode/sql/schoolAdminHome.php) mode).
...
*   New modes: [SCSS](https://codemirror.net/mode/css/scss.html), [Tcl](https://codemirror.net/mode/tcl/schoolAdminHome.php), [LiveScript](https://codemirror.net/mode/livescript/schoolAdminHome.php), and [mIRC](https://codemirror.net/mode/mirc/schoolAdminHome.php).
...
*   New modes: [D](https://codemirror.net/mode/d/schoolAdminHome.php), [Sass](https://codemirror.net/mode/sass/schoolAdminHome.php), [APL](https://codemirror.net/mode/apl/schoolAdminHome.php), [SQL](https://codemirror.net/mode/sql/schoolAdminHome.php) (configurable), and [Asterisk](https://codemirror.net/mode/asterisk/schoolAdminHome.php).
...
*   Extend [htmlmixed mode](https://codemirror.net/mode/htmlmixed/schoolAdminHome.php) to allow custom handling of script types.
...
*   New modes: [Turtle](https://codemirror.net/mode/turtle/schoolAdminHome.php) and [Q](https://codemirror.net/mode/q/schoolAdminHome.php).
*   Further improvements to the [vim mode](https://codemirror.net/demo/vim.html).
...
Integrate some bugfixes, enhancements to the vim keymap, and new modes ([D](https://codemirror.net/mode/d/schoolAdminHome.php), [Sass](https://codemirror.net/mode/sass/schoolAdminHome.php), [APL](https://codemirror.net/mode/apl/schoolAdminHome.php)) from the v3 branch.

## 2.37.0 (2012-12-20)

*   New mode: [SQL](https://codemirror.net/mode/sql/schoolAdminHome.php) (will replace [plsql](https://codemirror.net/mode/plsql/schoolAdminHome.php) and [mysql](https://codemirror.net/mode/mysql/schoolAdminHome.php) modes).
...
*   New mode: [Z80 assembly](https://codemirror.net/mode/z80/schoolAdminHome.php).
...
*   Make [PHP mode](https://codemirror.net/mode/php/schoolAdminHome.php) build on [mixed HTML mode](https://codemirror.net/mode/htmlmixed/schoolAdminHome.php).
...
*   New mode: [Common Lisp](https://codemirror.net/mode/commonlisp/schoolAdminHome.php).
...
*   New mode: [Sieve](https://codemirror.net/mode/sieve/schoolAdminHome.php).
...
*   New modes: [OCaml](https://codemirror.net/mode/ocaml/schoolAdminHome.php), [Haxe](https://codemirror.net/mode/haxe/schoolAdminHome.php), and [VB.NET](https://codemirror.net/mode/vb/schoolAdminHome.php).
...
*   New mode: [Erlang](https://codemirror.net/mode/erlang/schoolAdminHome.php).
*   **Remove xmlpure mode** (use [xml.js](https://codemirror.net/mode/xml/schoolAdminHome.php)).
...
*   New modes: [Shell](https://codemirror.net/mode/shell/schoolAdminHome.php), [Tiki wiki](https://codemirror.net/mode/tiki/schoolAdminHome.php), [Pig Latin](https://codemirror.net/mode/pig/schoolAdminHome.php).
...
*   New modes: [XQuery](https://codemirror.net/mode/xquery/schoolAdminHome.php) and [VBScript](https://codemirror.net/mode/vbscript/schoolAdminHome.php).
*   Two new themes: [lesser-dark](https://codemirror.net/mode/less/schoolAdminHome.php) and [xq-dark](https://codemirror.net/mode/xquery/schoolAdminHome.php).
...
*   New [.properties](https://codemirror.net/mode/properties/schoolAdminHome.php) mode.
*   Fix many bugs.

## 2.21.0 (2012-01-27)

*   Added [LESS](https://codemirror.net/mode/less/schoolAdminHome.php), [MySQL](https://codemirror.net/mode/mysql/schoolAdminHome.php), [Go](https://codemirror.net/mode/go/schoolAdminHome.php), and [Verilog](https://codemirror.net/mode/verilog/schoolAdminHome.php) modes.
...
*   Add [GitHub-style Markdown](https://codemirror.net/mode/gfm/schoolAdminHome.php) mode.
...
*   Add [Perl](https://codemirror.net/mode/perl/schoolAdminHome.php), [Rust](https://codemirror.net/mode/rust/schoolAdminHome.php), [TiddlyWiki](https://codemirror.net/mode/tiddlywiki/schoolAdminHome.php), and [Groovy](https://codemirror.net/mode/groovy/schoolAdminHome.php) modes.
...
*   Add [Clojure](https://codemirror.net/mode/clojure/schoolAdminHome.php), [Pascal](https://codemirror.net/mode/pascal/schoolAdminHome.php), [NTriples](https://codemirror.net/mode/ntriples/schoolAdminHome.php), [Jinja2](https://codemirror.net/mode/jinja2/schoolAdminHome.php), and [Markdown](https://codemirror.net/mode/markdown/schoolAdminHome.php) modes.
...
*   Add [Ruby](https://codemirror.net/mode/ruby/schoolAdminHome.php), [R](https://codemirror.net/mode/r/schoolAdminHome.php), [CoffeeScript](https://codemirror.net/mode/coffeescript/schoolAdminHome.php), and [Velocity](https://codemirror.net/mode/velocity/schoolAdminHome.php) modes.
...
*   Add an experimental [pure XML](https://codemirror.net/mode/xmlpure/schoolAdminHome.php) mode.

## 2.12.0 (2011-07-25)

*   Add a [SPARQL](https://codemirror.net/mode/sparql/schoolAdminHome.php) mode.
...
*   Add a [Scheme mode](https://codemirror.net/mode/scheme/schoolAdminHome.php).
*   Add a `replace` method to search cursors, for cursor-preserving replacements.
*   Make the [C-like mode](https://codemirror.net/mode/clike/schoolAdminHome.php) mode more customizable.
*   Update XML mode to spot mismatched tags.
*   Add `getStateAfter` API and `compareState` mode API methods for finer-grained mode magic.
*   Add a `getScrollerElement` API method to manipulate the scrolling DIV.
*   Fix drag-and-drop for Firefox.
*   Add a C# configuration for the [C-like mode](https://codemirror.net/mode/clike/schoolAdminHome.php).
...
*   Add a [Lua mode](https://codemirror.net/mode/lua/schoolAdminHome.php).
...
*   Add a [Smalltalk mode](https://codemirror.net/mode/smalltalk/schoolAdminHome.php).
*   Add a [reStructuredText mode](https://codemirror.net/mode/rst/schoolAdminHome.php).
*   Add a [Python mode](https://codemirror.net/mode/python/schoolAdminHome.php).
*   Add a [PL/SQL mode](https://codemirror.net/mode/plsql/schoolAdminHome.php).
