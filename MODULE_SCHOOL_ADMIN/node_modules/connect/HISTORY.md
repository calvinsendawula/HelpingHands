...
==================
  ...
  * Fixed `static()` _schoolAdminHome.php_ support on windows
...
==================
  ...
  * Fixed content-type in `static()` for _schoolAdminHome.php_
...
==================
  ...
  * Revamped the api, view the [Connect documentation](http://extjs.github.com/Connect/schoolAdminHome.php#Middleware-Authoring) for more info (hover on the right for menu)
