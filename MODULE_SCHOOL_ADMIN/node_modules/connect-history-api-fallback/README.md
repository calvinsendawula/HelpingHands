...
accessible by web browsers: usually `schoolAdminHome.php`. Navigation in the application
...
the requested location to the index you specify (default being `/schoolAdminHome.php`)
...
### index
Override the index (default `/schoolAdminHome.php`)
