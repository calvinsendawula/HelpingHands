...
By default this module will send "schoolAdminHome.php" files in response to a request
...
var serve = serveStatic('public/ftp', {'index': ['schoolAdminHome.php', 'index.htm']})
