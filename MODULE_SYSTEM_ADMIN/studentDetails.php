                ...
                <div class="card">
                  <div class="card-body">
                    <span class="text-right" style="display: flex; justify-content: space-between;">
                      <h4 class="card-title">Students Enrolled In Program</h4></span>
                          ...
                          <?php
                            for($i=0;$i<sizeof($studentClass8KCPEIndexNoArr);$i++){
                              ...
                              <tr class="text-center">
                                ...
                                <td>
                                  <a type="button" href="pages/forms/editStudent.php?studentID=<?php echo($studentClass8IDArr[$i]); ?>" class="btn btn-outline-success">Edit</a>
                                  <a type="button" href="pages/forms/deleteStudent.php?studentID=<?php echo($studentClass8IDArr[$i]); ?>" class="btn btn-outline-danger">Delete</a>
                                </td>
                              </tr>
                              <?php
                            }
                            ...
                            for($i=0;$i<sizeof($studentSponsoredFullNameArr);$i++){
                              ...
                              <tr>
                                ...
                                <td> <?php echo($studentSponsoredDonationClosingDateArr[$i]); ?> </td>
																<td>
                                  <a type="button" href="pages/forms/editSponsoredStudent.php?studentSponsoredID=<?php echo($studentSponsoredIDArr[$i]); ?>" class="btn btn-outline-success">Edit</a>
                                </td>
                              </tr>
                              <?php
                            }
