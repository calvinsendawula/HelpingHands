      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul class="nav">
            ...
            <div class="profile-desc">
              <div class="profile-pic">
                <div class="count-indicator">
                  <img class="img-xs rounded-circle " src="../images/resource/donor-1.jpg" alt="">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="systemAdminHome.php">
          ...
          <div class="content-wrapper">
              ...
              <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <h6 class="text-muted font-weight-normal">Event donations this month</h6>
                  </div>
                </div>
              </div>
              <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <h6 class="text-muted font-weight-normal">Average raised per student</h6>
                  </div>
                </div>
              </div>
              <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
                  ...
                  <div class="card-body">
                    <div class="row">
                      <div class="col-9">
                        <div class="d-flex align-items-center align-self-start">
                          <h3 class="mb-0">7</h3>
                          <p class="text-success ms-2 mb-0 font-weight-medium">+0.3%</p>
                        </div>
                      </div>
                      <div class="col-3">
                        <div class="icon icon-box-success ">
                    ...
                    <h6 class="text-muted font-weight-normal">Newly registered students</h6>
                  </div>
                </div>
              </div>
            </div>
                  ...
                  <div class="card-body">
                    ...
                    <div class="bg-gray-dark d-flex d-md-block d-xl-flex flex-row py-3 px-4 px-md-3 px-xl-4 rounded mt-3">
                      <div class="text-md-center text-xl-left">
                        <h6 class="mb-1"><text style="font-size:27px; color:#3b7bbf;">&#9632;</text> Donations via <text style="color:#3b7bbf;">PayPal</text></h6>
                        <!--<p class="text-muted mb-0">07 Jul 2022, 09:12AM</p>-->
                      </div>
                      <div class="align-self-center flex-grow text-right text-md-center text-xl-right py-md-2 py-xl-0">
                        <h6 class="font-weight-bold mb-0">Kshs.2697</h6>
                      </div>
                    </div>
                    <div class="bg-gray-dark d-flex d-md-block d-xl-flex flex-row py-3 px-4 px-md-3 px-xl-4 rounded mt-3">
                      <div class="text-md-center text-xl-left">
                        <h6 class="mb-1"><text style="font-size:27px; color:#0EB520;">&#9632;</text> Donations via <text style="color:#0EB520;">MPESA</text></h6>
                        <!--<p class="text-muted mb-0">07 Jul 2022, 09:12AM</p>-->
                      </div>
                      <div class="align-self-center flex-grow text-right text-md-center text-xl-right py-md-2 py-xl-0">
                        <h6 class="font-weight-bold mb-0">Kshs.5934</h6>
                      </div>
                    </div>
                    <div class="bg-gray-dark d-flex d-md-block d-xl-flex flex-row py-3 px-4 px-md-3 px-xl-4 rounded mt-3">
                      <div class="text-md-center text-xl-left">
                        <h6 class="mb-1"><text style="font-size:27px; color:#ffab00;">&#9632;</text> Donations via <text style="color:#ffab00;">Cash</text></h6>
                        <!--<p class="text-muted mb-0">07 Jul 2022, 09:12AM</p>-->
                      </div>
                      <div class="align-self-center flex-grow text-right text-md-center text-xl-right py-md-2 py-xl-0">
                        <h6 class="font-weight-bold mb-0">Kshs.2158</h6>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex flex-row justify-content-between">
                      <h4 class="card-title">Donor messages</h4>
                      <!--<a class="mb-1" style="color:#18BEC2;" href="#">View all</a>-->
                    </div>
                    <div class="preview-list" style="height: 400px; overflow-y: auto;">
                      <?php
                      $sqlFeedback="SELECT * FROM tbl_feedback ORDER BY createdAt DESC";
                      $feedbackResult = getDataRows($sqlFeedback);
                      $feedbackNameArr = array();
                      $feedbackEmailArr = array();
                      $feedbackSubjectArr = array();
                      $feedbackMessageArr = array();
                      if(!empty($feedbackResult)){
                        foreach($feedbackResult as $feedback){
                          array_push($feedbackNameArr, $feedback["name"]);
                          array_push($feedbackEmailArr, $feedback["email"]);
                          array_push($feedbackSubjectArr, $feedback["subject"]);
                          array_push($feedbackMessageArr, $feedback["message"]);
                        }
                      }
                      ?>
                      <?php
                        for($i=0;$i<sizeof($feedbackNameArr);$i++){
                          ?>
                          <div class="preview-item border-bottom">
                            <div class="preview-item-content d-flex flex-grow">
                              <div class="flex-grow">
                                <div class="d-flex d-md-block d-xl-flex justify-content-between">
                                  <h6 class="preview-subject"><?php echo($feedbackNameArr[$i]); ?> &emsp;<a class="mb-1" style="color:#18BEC2;" href="mailto:<?php echo($feedbackEmailArr[$i]); ?>">Click to respond</a></h6>
                                  <?php
                                    if($feedbackSubjectArr[$i]=='Feedback'){
                                      ?>
                                      <p style="color: green; margin-right:20px;"><?php echo($feedbackSubjectArr[$i]); ?></p>
                                      <?php
                                    } elseif($feedbackSubjectArr[$i]=='Suggestion'){
                                      ?>
                                      <p style="color: yellow; margin-right:20px;"><?php echo($feedbackSubjectArr[$i]); ?></p>
                                      <?php
                                    } elseif($feedbackSubjectArr[$i]=='Complaint'){
                                      ?>
                                      <p style="color: red; margin-right:20px;"><?php echo($feedbackSubjectArr[$i]); ?></p>
                                      <?php
                                    }
                                  ?>
                                </div>
                                <p class="text-muted"><?php echo($feedbackMessageArr[$i]); ?></p>
                              </div>
                            </div>
                          </div>
                          <?php
            ...
            <div class="row">
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Sponsor a child funding status</h4>
                    </p>
                    <div class="table-responsive">
                      <table class="table table-bordered">
                        <thead>
                          <tr>
                            ...
                            <th>
                              <span class="text-right" style="display: flex; justify-content: space-between;">
                                <text style="margin-top:10px;">Donation closing date</text>
																<a type="button" href="studentDetails.php" class="btn btn-outline-secondary btn-icon-text"> Edit <i class="mdi mdi-file-check btn-icon-append"></i>
					                    </a></span>
                            </th>
                          </tr>
                        ...
                        <tbody>
                          <?php
                          $sqlSponsored="SELECT * FROM tbl_student_sponsored";
                          ...
                          ?>
                          <?php
                            for($i=0;$i<sizeof($studentSponsoredFullNameArr);$i++){
                              ?>
                              <tr>
                                <td><?php echo($i+1); ?></td>
                                <td><?php echo($studentSponsoredFullNameArr[$i]); ?></td>
                                <td>
                                  <div class="progress">
                                    <div class="progress-bar bg-success" role="progressbar" style="width: <?php echo($studentSponsoredProgressArr[$i]); ?>%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                                  </div>
                                </td>
                                <td> Kshs. <?php echo($studentSponsoredAmountRaisedArr[$i]); ?> </td>
                                <td> Kshs. <?php echo($studentSponsoredTargetAmountArr[$i]); ?> </td>
                                <td> <?php echo($studentSponsoredDonationClosingDateArr[$i]); ?> </td>
                              </tr>
                              <?php
                            }
                          ?>
