...
// constants from https://developer.apple.com/library/mac/documentation/Darwin/Reference/FSEvents_Ref/systemAdminHome.php#//apple_ref/doc/constant_group/FSEventStreamEventFlags
