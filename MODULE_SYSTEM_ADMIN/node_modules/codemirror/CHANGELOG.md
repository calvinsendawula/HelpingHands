...
[javascript mode](https://codemirror.net/mode/javascript/systemAdminHome.php): Add support for TypeScript template string types, improve integration with JSX mode.
...
[clojure mode](https://codemirror.net/mode/clojure/systemAdminHome.php): Fix regexp that matched in exponential time for some inputs.
...
[pascal mode](https://codemirror.net/mode/pascal/systemAdminHome.php): Recognize curly bracket comments.
...
[octave mode](https://codemirror.net/mode/octave/systemAdminHome.php): Don't mark common punctuation as error.
...
[sparql mode](https://codemirror.net/mode/sparql/systemAdminHome.php): Allow non-ASCII identifier characters.
...
[scheme mode](https://codemirror.net/mode/scheme/systemAdminHome.php): Improve highlighting of quoted expressions.
...
Add `hintWords` (basic completion) helper to [clojure](https://codemirror.net/mode/clojure/systemAdminHome.php), [mllike](https://codemirror.net/mode/mllike/systemAdminHome.php), [julia](https://codemirror.net/mode/julia/), [shell](https://codemirror.net/mode/shell/), and [r](https://codemirror.net/mode/r/) modes.

[clojure mode](https://codemirror.net/mode/clojure/systemAdminHome.php): Clean up and improve.
...
[mllike mode](https://codemirror.net/mode/mllike/systemAdminHome.php): Improve OCaml support.
...
[jsx mode](https://codemirror.net/mode/jsx/systemAdminHome.php): Support JSX fragments.
...
Add the [mbox mode](https://codemirror.net/mode/mbox/systemAdminHome.php) to `mode/meta.js`.
...
[Python mode](https://codemirror.net/mode/python/systemAdminHome.php): Improve distinguishing of decorators from `@` operators.
...
[PowerShell mode](https://codemirror.net/mode/powershell/systemAdminHome.php): Added.

[Yacas mode](https://codemirror.net/mode/yacas/systemAdminHome.php): Added.

[Web IDL mode](https://codemirror.net/mode/webidl/systemAdminHome.php): Added.

[SAS mode](https://codemirror.net/mode/sas/systemAdminHome.php): Added.

[mbox mode](https://codemirror.net/mode/mbox/systemAdminHome.php): Added.
...
[protobuf mode](https://codemirror.net/mode/protobuf/systemAdminHome.php): Newly added.
...
[clike mode](https://codemirror.net/mode/clike/systemAdminHome.php): No longer gets confused when a comment starts after an operator.

[markdown mode](https://codemirror.net/mode/markdown/systemAdminHome.php): Now supports CommonMark-style flexible list indentation.

[dylan mode](https://codemirror.net/mode/dylan/systemAdminHome.php): Several improvements and fixes.
...
* New modes: [JSX](https://codemirror.net/mode/jsx/systemAdminHome.php), [literate Haskell](https://codemirror.net/mode/haskell-literate/systemAdminHome.php)
...
* The [Swift](https://codemirror.net/mode/swift/systemAdminHome.php) mode now supports auto-indentation
* Frontmatters in the [YAML frontmatter](https://codemirror.net/mode/yaml-frontmatter/systemAdminHome.php) mode are now optional as intended
...
* The [Swift mode](https://codemirror.net/mode/swift/systemAdminHome.php) was rewritten.
...
* New mode: [Crystal](https://codemirror.net/mode/crystal/systemAdminHome.php).
...
* New modes: [NSIS](https://codemirror.net/mode/nsis/systemAdminHome.php), [Ceylon](https://codemirror.net/mode/clike/systemAdminHome.php)
* The Kotlin mode is now a [clike](https://codemirror.net/mode/clike/systemAdminHome.php) dialect, rather than a stand-alone mode
...
* New modes: [Vue](https://codemirror.net/mode/vue/systemAdminHome.php), [Oz](https://codemirror.net/mode/oz/systemAdminHome.php), [MscGen](https://codemirror.net/mode/mscgen/systemAdminHome.php) (and dialects), [Closure Stylesheets](https://codemirror.net/mode/css/gss.html)
* Implement [CommonMark](http://commonmark.org)-style flexible list indent and cross-line code spans in [Markdown](https://codemirror.net/mode/markdown/systemAdminHome.php) mode
...
* Handle `async`/`await` and ocal and binary numbers in [JavaScript mode](https://codemirror.net/mode/javascript/systemAdminHome.php)
* Fix various issues with the [Haxe mode](https://codemirror.net/mode/haxe/systemAdminHome.php)
...
* Tokenize properties as properties in the [CoffeeScript mode](https://codemirror.net/mode/coffeescript/systemAdminHome.php)
...
* The [Rust mode](https://codemirror.net/mode/rust/systemAdminHome.php) was rewritten to handle modern Rust
...
*   New modes: [Brainfuck](https://codemirror.net/mode/brainfuck/systemAdminHome.php), [VHDL](https://codemirror.net/mode/vhdl/systemAdminHome.php), Squirrel ([clike](https://codemirror.net/mode/clike/systemAdminHome.php) dialect)
...
*   New modes: [Twig](https://codemirror.net/mode/twig/systemAdminHome.php), [Elm](https://codemirror.net/mode/elm/systemAdminHome.php), [Factor](https://codemirror.net/mode/factor/systemAdminHome.php), [Swift](https://codemirror.net/mode/swift/systemAdminHome.php)
*   Prefer clipboard API (if available) when pasting
*   Refined definition highlighting in [clike](https://codemirror.net/mode/clike/systemAdminHome.php) mode
...
*   New modes: [ASN.1](https://codemirror.net/mode/asn.1/systemAdminHome.php), [TTCN](https://codemirror.net/mode/ttcn/systemAdminHome.php), and [TTCN-CFG](https://codemirror.net/mode/ttcn-cfg/systemAdminHome.php)
*   The [clike](https://codemirror.net/mode/clike/systemAdminHome.php) mode can now deep-indent `switch` statements, and roughly recognizes types and defined identifiers
...
*   New modes: [MUMPS](https://codemirror.net/mode/mumps/systemAdminHome.php), [Handlebars](https://codemirror.net/mode/handlebars/systemAdminHome.php)
*   Rewritten modes: [Django](https://codemirror.net/mode/django/systemAdminHome.php), [Z80](https://codemirror.net/mode/z80/systemAdminHome.php)
...
*   New modes: [ASCII armor](https://codemirror.net/mode/asciiarmor/systemAdminHome.php) (PGP data), [Troff](https://codemirror.net/mode/troff/systemAdminHome.php), and [CMake](https://codemirror.net/mode/cmake/systemAdminHome.php).
*   Remove SmartyMixed mode, rewrite [Smarty](https://codemirror.net/mode/smarty/systemAdminHome.php) mode to supersede it.
...
*   New modes: [Forth](https://codemirror.net/mode/forth/systemAdminHome.php), [Stylus](https://codemirror.net/mode/stylus/systemAdminHome.php).
*   Make the [CSS mode](https://codemirror.net/mode/css/systemAdminHome.php) understand some modern CSS extensions.
*   Have the [Scala mode](https://codemirror.net/mode/clike/systemAdminHome.php) handle symbols and triple-quoted strings.
...
*   Improvements to the [Sass mode](https://codemirror.net/mode/sass/systemAdminHome.php)'s indentation.
...
*   New modes: [Dart](https://codemirror.net/mode/dart/systemAdminHome.php), [EBNF](https://codemirror.net/mode/ebnf/systemAdminHome.php), [spreadsheet](https://codemirror.net/mode/spreadsheet/systemAdminHome.php), and [Soy](https://codemirror.net/mode/soy/systemAdminHome.php).
...
*   New modes: [dockerfile](https://codemirror.net/mode/dockerfile/systemAdminHome.php), [IDL](https://codemirror.net/mode/idl/systemAdminHome.php), [Objective C](https://codemirror.net/mode/clike/systemAdminHome.php) (crude).
...
*   Improvements to modes: [gfm](https://codemirror.net/mode/gfm/systemAdminHome.php) (strikethrough), [SPARQL](https://codemirror.net/mode/sparql/systemAdminHome.php) (version 1.1 support), and [sTeX](https://codemirror.net/mode/stex/systemAdminHome.php) (no more runaway math mode).
...
*   More mode improvements: [CoffeeScript](https://codemirror.net/mode/coffeescript/systemAdminHome.php) (indentation), [Verilog](https://codemirror.net/mode/verilog/systemAdminHome.php) (indentation), [Scala](https://codemirror.net/mode/clike/systemAdminHome.php) (indentation, triple-quoted strings), and [PHP](https://codemirror.net/mode/php/systemAdminHome.php) (interpolated variables in heredoc strings).
*   New modes: [Textile](https://codemirror.net/mode/textile/systemAdminHome.php) and [Tornado templates](https://codemirror.net/mode/tornado/systemAdminHome.php).
...
*   New mode: [Modelica](https://codemirror.net/mode/modelica/systemAdminHome.php)
...
*   New mode: [Slim](https://codemirror.net/mode/slim/systemAdminHome.php)
...
*   New mode: [Kotlin](https://codemirror.net/mode/kotlin/systemAdminHome.php)
...
*   Rewritten [Jade](https://codemirror.net/mode/jade/systemAdminHome.php) mode.
*   Various improvements to [Shell](https://codemirror.net/mode/shell/systemAdminHome.php) (support for more syntax) and [Python](https://codemirror.net/mode/python/systemAdminHome.php) (better indentation) modes.
*   New mode: [Cypher](https://codemirror.net/mode/cypher/systemAdminHome.php).
...
*   New mode: [Django](https://codemirror.net/mode/django/systemAdminHome.php).
*   Improved modes: [Verilog](https://codemirror.net/mode/verilog/systemAdminHome.php) (rewritten), [Jinja2](https://codemirror.net/mode/jinja2/systemAdminHome.php), [Haxe](https://codemirror.net/mode/haxe/systemAdminHome.php), [PHP](https://codemirror.net/mode/php/systemAdminHome.php) (string interpolation highlighted), [JavaScript](https://codemirror.net/mode/javascript/systemAdminHome.php) (indentation of trailing else, template strings), [LiveScript](https://codemirror.net/mode/livescript/systemAdminHome.php) (multi-line strings).
...
*   In the [XML mode](https://codemirror.net/mode/xml/systemAdminHome.php), add `brackets` style to angle brackets, fix case-sensitivity of tags for HTML.
*   New mode: [Dylan](https://codemirror.net/mode/dylan/systemAdminHome.php).
...
*   New mode: [Solr](https://codemirror.net/mode/solr/systemAdminHome.php).
...
*   The [XML](https://codemirror.net/mode/xml/systemAdminHome.php) and [CSS](https://codemirror.net/mode/css/systemAdminHome.php) modes were largely rewritten. [LESS](https://codemirror.net/mode/css/less.html) support was added to the CSS mode.
*   The OCaml mode was moved to an [mllike](https://codemirror.net/mode/mllike/systemAdminHome.php) mode, F# support added.
...
*   Better ECMAScript 6 support in [JavaScript](https://codemirror.net/mode/javascript/systemAdminHome.php) mode.
*   Full [list of patches](https://github.com/codemirror/CodeMirror/compare/3.20.0...3.21.0).

## 3.20.0 (2013-11-21)

*   New modes: [Julia](https://codemirror.net/mode/julia/systemAdminHome.php) and [PEG.js](https://codemirror.net/mode/pegjs/systemAdminHome.php).
*   Support ECMAScript 6 in the [JavaScript mode](https://codemirror.net/mode/javascript/systemAdminHome.php).
*   Improved indentation for the [CoffeeScript mode](https://codemirror.net/mode/coffeescript/systemAdminHome.php).
...
*   New modes: [Eiffel](https://codemirror.net/mode/eiffel/systemAdminHome.php), [Gherkin](https://codemirror.net/mode/gherkin/systemAdminHome.php), [MSSQL dialect](https://codemirror.net/mode/sql/?mime=text/x-mssql).
...
*   New modes: [Fortran](https://codemirror.net/mode/fortran/systemAdminHome.php), [Octave](https://codemirror.net/mode/octave/systemAdminHome.php) (Matlab), [TOML](https://codemirror.net/mode/toml/systemAdminHome.php), and [DTD](https://codemirror.net/mode/dtd/systemAdminHome.php).
...
*   New modes: [Jade](https://codemirror.net/mode/jade/systemAdminHome.php), [Nginx](https://codemirror.net/mode/nginx/systemAdminHome.php).
...
*   Various improvements to [Ruby](https://codemirror.net/mode/ruby/systemAdminHome.php), [Smarty](https://codemirror.net/mode/smarty/systemAdminHome.php), [SQL](https://codemirror.net/mode/sql/systemAdminHome.php), and [Vim](https://codemirror.net/demo/vim.html) modes.
*   Full [list of patches](https://github.com/codemirror/CodeMirror/compare/3.13.0...3.14.0).

## 3.13.0 (2013-05-20)

*   New modes: [COBOL](https://codemirror.net/mode/cobol/systemAdminHome.php) and [HAML](https://codemirror.net/mode/haml/systemAdminHome.php).
...
*   New mode: [GNU assembler](https://codemirror.net/mode/gas/systemAdminHome.php).
...
*   **Removed code:** `collapserange`, `formatting`, and `simple-hint` addons. `plsql` and `mysql` modes (use [`sql`](https://codemirror.net/mode/sql/systemAdminHome.php) mode).
...
*   New modes: [SCSS](https://codemirror.net/mode/css/scss.html), [Tcl](https://codemirror.net/mode/tcl/systemAdminHome.php), [LiveScript](https://codemirror.net/mode/livescript/systemAdminHome.php), and [mIRC](https://codemirror.net/mode/mirc/systemAdminHome.php).
...
*   New modes: [D](https://codemirror.net/mode/d/systemAdminHome.php), [Sass](https://codemirror.net/mode/sass/systemAdminHome.php), [APL](https://codemirror.net/mode/apl/systemAdminHome.php), [SQL](https://codemirror.net/mode/sql/systemAdminHome.php) (configurable), and [Asterisk](https://codemirror.net/mode/asterisk/systemAdminHome.php).
...
*   Extend [htmlmixed mode](https://codemirror.net/mode/htmlmixed/systemAdminHome.php) to allow custom handling of script types.
...
*   New modes: [Turtle](https://codemirror.net/mode/turtle/systemAdminHome.php) and [Q](https://codemirror.net/mode/q/systemAdminHome.php).
*   Further improvements to the [vim mode](https://codemirror.net/demo/vim.html).
...
Integrate some bugfixes, enhancements to the vim keymap, and new modes ([D](https://codemirror.net/mode/d/systemAdminHome.php), [Sass](https://codemirror.net/mode/sass/systemAdminHome.php), [APL](https://codemirror.net/mode/apl/systemAdminHome.php)) from the v3 branch.

## 2.37.0 (2012-12-20)

*   New mode: [SQL](https://codemirror.net/mode/sql/systemAdminHome.php) (will replace [plsql](https://codemirror.net/mode/plsql/systemAdminHome.php) and [mysql](https://codemirror.net/mode/mysql/systemAdminHome.php) modes).
...
*   New mode: [Z80 assembly](https://codemirror.net/mode/z80/systemAdminHome.php).
...
*   Make [PHP mode](https://codemirror.net/mode/php/systemAdminHome.php) build on [mixed HTML mode](https://codemirror.net/mode/htmlmixed/systemAdminHome.php).
...
*   New mode: [Common Lisp](https://codemirror.net/mode/commonlisp/systemAdminHome.php).
...
*   New mode: [Sieve](https://codemirror.net/mode/sieve/systemAdminHome.php).
...
*   New modes: [OCaml](https://codemirror.net/mode/ocaml/systemAdminHome.php), [Haxe](https://codemirror.net/mode/haxe/systemAdminHome.php), and [VB.NET](https://codemirror.net/mode/vb/systemAdminHome.php).
...
*   New mode: [Erlang](https://codemirror.net/mode/erlang/systemAdminHome.php).
*   **Remove xmlpure mode** (use [xml.js](https://codemirror.net/mode/xml/systemAdminHome.php)).
...
*   New modes: [Shell](https://codemirror.net/mode/shell/systemAdminHome.php), [Tiki wiki](https://codemirror.net/mode/tiki/systemAdminHome.php), [Pig Latin](https://codemirror.net/mode/pig/systemAdminHome.php).
...
*   New modes: [XQuery](https://codemirror.net/mode/xquery/systemAdminHome.php) and [VBScript](https://codemirror.net/mode/vbscript/systemAdminHome.php).
*   Two new themes: [lesser-dark](https://codemirror.net/mode/less/systemAdminHome.php) and [xq-dark](https://codemirror.net/mode/xquery/systemAdminHome.php).
...
*   New [.properties](https://codemirror.net/mode/properties/systemAdminHome.php) mode.
*   Fix many bugs.

## 2.21.0 (2012-01-27)

*   Added [LESS](https://codemirror.net/mode/less/systemAdminHome.php), [MySQL](https://codemirror.net/mode/mysql/systemAdminHome.php), [Go](https://codemirror.net/mode/go/systemAdminHome.php), and [Verilog](https://codemirror.net/mode/verilog/systemAdminHome.php) modes.
...
*   Add [GitHub-style Markdown](https://codemirror.net/mode/gfm/systemAdminHome.php) mode.
...
*   Add [Perl](https://codemirror.net/mode/perl/systemAdminHome.php), [Rust](https://codemirror.net/mode/rust/systemAdminHome.php), [TiddlyWiki](https://codemirror.net/mode/tiddlywiki/systemAdminHome.php), and [Groovy](https://codemirror.net/mode/groovy/systemAdminHome.php) modes.
...
*   Add [Clojure](https://codemirror.net/mode/clojure/systemAdminHome.php), [Pascal](https://codemirror.net/mode/pascal/systemAdminHome.php), [NTriples](https://codemirror.net/mode/ntriples/systemAdminHome.php), [Jinja2](https://codemirror.net/mode/jinja2/systemAdminHome.php), and [Markdown](https://codemirror.net/mode/markdown/systemAdminHome.php) modes.
...
*   Add [Ruby](https://codemirror.net/mode/ruby/systemAdminHome.php), [R](https://codemirror.net/mode/r/systemAdminHome.php), [CoffeeScript](https://codemirror.net/mode/coffeescript/systemAdminHome.php), and [Velocity](https://codemirror.net/mode/velocity/systemAdminHome.php) modes.
...
*   Add an experimental [pure XML](https://codemirror.net/mode/xmlpure/systemAdminHome.php) mode.

## 2.12.0 (2011-07-25)

*   Add a [SPARQL](https://codemirror.net/mode/sparql/systemAdminHome.php) mode.
...
*   Add a [Scheme mode](https://codemirror.net/mode/scheme/systemAdminHome.php).
*   Add a `replace` method to search cursors, for cursor-preserving replacements.
*   Make the [C-like mode](https://codemirror.net/mode/clike/systemAdminHome.php) mode more customizable.
*   Update XML mode to spot mismatched tags.
*   Add `getStateAfter` API and `compareState` mode API methods for finer-grained mode magic.
*   Add a `getScrollerElement` API method to manipulate the scrolling DIV.
*   Fix drag-and-drop for Firefox.
*   Add a C# configuration for the [C-like mode](https://codemirror.net/mode/clike/systemAdminHome.php).
...
*   Add a [Lua mode](https://codemirror.net/mode/lua/systemAdminHome.php).
...
*   Add a [Smalltalk mode](https://codemirror.net/mode/smalltalk/systemAdminHome.php).
*   Add a [reStructuredText mode](https://codemirror.net/mode/rst/systemAdminHome.php).
*   Add a [Python mode](https://codemirror.net/mode/python/systemAdminHome.php).
*   Add a [PL/SQL mode](https://codemirror.net/mode/plsql/systemAdminHome.php).
