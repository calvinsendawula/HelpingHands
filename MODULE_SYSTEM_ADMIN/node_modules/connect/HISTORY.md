...
==================
  ...
  * Fixed `static()` _systemAdminHome.php_ support on windows
...
==================
  ...
  * Fixed content-type in `static()` for _systemAdminHome.php_
...
==================
  ...
  * Revamped the api, view the [Connect documentation](http://extjs.github.com/Connect/systemAdminHome.php#Middleware-Authoring) for more info (hover on the right for menu)
