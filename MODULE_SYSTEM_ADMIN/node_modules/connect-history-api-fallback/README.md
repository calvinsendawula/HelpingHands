...
accessible by web browsers: usually `systemAdminHome.php`. Navigation in the application
...
the requested location to the index you specify (default being `/systemAdminHome.php`)
...
### index
Override the index (default `/systemAdminHome.php`)
