...
By default this module will send "systemAdminHome.php" files in response to a request
...
var serve = serveStatic('public/ftp', {'index': ['systemAdminHome.php', 'index.htm']})
