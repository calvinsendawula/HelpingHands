              ...
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="../../studentDetails.php">
                  <span class="menu-title">View Details</span>
								...
								<li class="nav-item"> <a class="nav-link" href="deleteStudent.php">
                  <span class="menu-title">Delete Student</span>
                </a></li>
              </ul>
            </div>
          </li>
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Delete student </h3>
            </div>
            <div class="row">
              ...
              <div class="col-md-8 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title"><?php echo($varFName." ".$varMName." ".$varLName); ?></h4>
                    <form class="forms-sample" method="post" action="../formsPHP/processDeleteStudent.php?studentDeleteID=<?php echo $varStudentID; ?>">
                      <div class="form-group row">
                        <label for="fname" class="col-sm-2 col-form-label">First Name</label>
                        <div class="col-sm-10">
                          <input type="text" name="fname" style="width: 100%;" id="fname" value="<?php echo($varFName); ?>" disabled>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="mname" class="col-sm-2 col-form-label">Middle Name</label>
                        <div class="col-sm-10">
                          <input type="text" name="mname" style="width: 100%;" id="mname" value="<?php echo($varMName); ?>" disabled>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="lname" class="col-sm-2 col-form-label">Last Name</label>
                        <div class="col-sm-10">
                          <input type="text" name="lname" style="width: 100%;" id="lname" value="<?php echo($varLName); ?>" disabled>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="kcpe" class="col-sm-2 col-form-label">Index No</label>
                        <div class="col-sm-10">
                          <input type="number" name="kcpe" style="width: 100%;" id="kcpe" value="<?php echo($studentClass8KCPEIndexNoArr[0]); ?>" disabled>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="email" class="col-sm-2 col-form-label">Email</label>
                        <div class="col-sm-10">
                          <input type="email" name="email" style="width: 100%;" id="email" value="<?php echo($varEmailAddress); ?>" disabled>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="stream" class="col-sm-2 col-form-label">Stream</label>
                        <div class="col-sm-10">
                          <input type="text" name="stream" style="width: 100%;" id="stream" value="<?php echo($studentClass8StreamArr[0]); ?>" disabled>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="gcontact" class="col-sm-2 col-form-label">Guardian Contact</label>
                        <div class="col-sm-10">
                          <input type="text" name="gcontact" style="width: 100%;" maxlength="10" id="gcontact" value="<?php echo($studentClass8GuardianContactArr[0]); ?>" disabled>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="natID" class="col-sm-2 col-form-label">Guardian ID</label>
                        <div class="col-sm-10">
                          <input type="number" name="natID" style="width: 100%;" maxlength="8" id="natID" value="<?php echo($studentClass8GuardianNatIdOrPassportNoArr[0]); ?>" disabled>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="status" class="col-sm-2 col-form-label">Sponsorship Status</label>
                        <div class="col-sm-2">
                          <input type="text" style="width: 100%;" value="<?php echo($studentClass8SponsorAChildStatusArr[0]); ?>" disabled>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="rejectReason" class="col-sm-2 col-form-label">Rejected Reason</label>
                        <div class="col-sm-2">
                          <input type="text" style="width: 100%;" value="<?php echo($studentClass8SponsorAChildStatusRejectionMessageArr[0]); ?>" disabled>
                        </div>
                      </div>
                      <button type="submit" class="btn btn-danger me-2">Proceed to delete</button>
