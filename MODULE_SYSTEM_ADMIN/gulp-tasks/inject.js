...
gulp.task('injectPartial', function () {
    return gulp.src(["./pages/*/*.html", "./systemAdminHome.php"], {
            base: "./"
        })
        .pipe(injectPartials())
        .pipe(gulp.dest("."));
...
gulp.task('replacePath', function () {
    var replacePath1 = gulp.src('./pages/**/*.html', {
        ...
        .pipe(replace('href="systemAdminHome.php"', 'href="../../systemAdminHome.php"'))
        .pipe(gulp.dest('.'));
    var replacePath2 = gulp.src('./**/systemAdminHome.php', {
            base: "./"
        })
        .pipe(replace('href="documentation"', 'href="http://www.bootstrapdash.com/demo/corona-free/jquery/documentation/documentation.html"'))
        .pipe(gulp.dest('.'));
